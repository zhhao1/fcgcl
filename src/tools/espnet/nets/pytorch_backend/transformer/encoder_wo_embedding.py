...
class Encoder_wo_Embedding(torch.nn.Module):
    ...
    def __init__(
        ...
        super(Encoder_wo_Embedding, self).__init__()
    ...
    def forward(self, xs, masks, args=None):
        ...
        for i_layer, encoder_layer in enumerate(self.encoders):
            ...
            if self.dropdim and args is not None:
                if args.mask_random:
